...
class _CreateChannelDialogState extends State<CreateChannelDialog> {
  ...
  Future<void> _handleSubmit() async {
    ...
    widget.onSubmit(_nameController.text.trim().toLowerCase().replaceAll(' ', '-'), _selectedType);
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isSubmitting
                          ? const SizedBox(width: 18, height: 18, child: CircularProgressIndicator(strokeWidth: 2, valueColor: AlwaysStoppedAnimation<Color>(AppColors.white)))
                          : Text('Tạo', style: TextStyle(fontWeight: FontWeight.bold, fontSize: isSmallScreen ? 13 : 14)),
                    ),
                  ),
                ),
              ],
