...
class _SetupProfileScreenState extends State<SetupProfileScreen> {
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Row(
        children: [
          IconButton(onPressed: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const LoginScreen())), icon: const Icon(Icons.arrow_back, color: AppColors.textPrimary), style: IconButton.styleFrom(backgroundColor: AppColors.surface)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSizes.paddingXL),
          _buildTextField(label: 'TÊN HIỂN THỊ', hint: 'ShadowHunter_99', controller: _displayNameController, icon: Icons.person_outline),
          const SizedBox(height: AppSizes.paddingL),
